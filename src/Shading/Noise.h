...
public:
	...
	virtual Float getValue(const Point2f &uv) const;
private:
...
inline Float PerlinNoise2D::getValue(const Point2f &uv) const
{
	Float total = 0.0;
...
public:
	...
	virtual Float getValue(const Point3f &uv) const;
private:
...
inline Float PerlinNoise3D::getValue(const Point3f &uv) const
{
	Float total = 0.0;
