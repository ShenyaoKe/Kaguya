...
struct DifferentialGeometry
{
	...
	void setReflectDir(const Vector3D& rVec);
 	...
 	double getDiffuseTheta() const;
 	double getSpecularTheta() const;
};
...
inline double DifferentialGeometry::getDiffuseTheta() const
{
	return lightDir * normal;
}
inline double DifferentialGeometry::getSpecularTheta() const
{
