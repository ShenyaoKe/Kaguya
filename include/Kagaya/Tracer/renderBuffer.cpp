...
void bufferData::setDepth(double d)
{
	depth = d;
}
...
{
	return ColorRGBA(0.5 - this->normalVec.x / 2, 0.5 - this->normalVec.y / 2, 0.5 - this->normalVec.z / 2);
}
...
double bufferData::getDepth() const
{
	return this->depth;
}
/************************************************************************/
...
void renderBuffer::setDepth(int x, int y, double d)
{
